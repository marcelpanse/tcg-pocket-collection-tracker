...
export function ToastViewport({ className, ...props }: ToastPrimitives.ToastViewportProps) {
  return (
...
export function Toast({ className, variant, ...props }: ToastPrimitives.ToastProps & VariantProps<typeof toastVariants>) {
  return <ToastPrimitives.Root className={cn(toastVariants({ variant }), className)} {...props} />
}

export function ToastAction({ className, ...props }: ToastPrimitives.ToastActionProps) {
  return (
...
export function ToastClose({ className, ...props }: ToastPrimitives.ToastCloseProps) {
  return (
...
export function ToastTitle({ className, ...props }: ToastPrimitives.ToastTitleProps) {
  return <ToastPrimitives.Title className={cn('font-semibold text-sm [&+div]:text-xs', className)} {...props} />
}

export function ToastDescription({ className, ...props }: ToastPrimitives.ToastDescriptionProps) {
